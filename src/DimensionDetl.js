...
function DimensionDetl({navigation,route}) {
            ...
            <ScrollView contentContainerStyle={{width:Dimensions.get('window').width*0.9,alignItems:'center',marginStart:Dimensions.get('window').width*0.045}}>
                ...
                {(route.params.urlData.packs.length>0)?(
                 <View style={{flexDirection:'row',flex:1,justifyContent:'space-around',borderColor:'black',borderWidth:2}}>
                     ...
                     <Text>Case Size, Pack Number:</Text>
                     </View>
                     <View style={{flex:1}}>
                ...
                <View style={{flexDirection:'row',flex:1,justifyContent:'space-around',borderColor:'black',borderWidth:2}}>
                 ...
                 <View style={{justifyContent:'flex-start',flex:1,flexDirection:'row'}}>
                 <Text>{route.params.dimLength}</Text>
                 </View>
                </View>
                <View style={{flexDirection:'row',flex:1,justifyContent:'space-around',borderColor:'black',borderWidth:2}}>
                 <View style={{justifyContent:'center',flex:1,flexDirection:'row'}}>
                 <Text>Case Width:</Text>
                 </View>
                 <View style={{justifyContent:'flex-start',flex:1,flexDirection:'row'}}>
                 <Text>{route.params.dimWidth}</Text>
                 </View>
                </View>
                <View style={{flexDirection:'row',flex:1,justifyContent:'space-around',borderColor:'black',borderWidth:2}}>
                 <View style={{justifyContent:'center',flex:1,flexDirection:'row'}}>
                 ...
                 <View style={{justifyContent:'flex-start',flex:1,flexDirection:'row'}}>
                 <Text>{route.params.dimHeight}</Text>
                 </View>
                </View>
                <View style={{flexDirection:'row',flex:1,justifyContent:'space-around',borderColor:'black',borderWidth:2}}>
                 <View style={{justifyContent:'center',flex:1,flexDirection:'row'}}>
                 <Text>Case Weight:</Text>
                 </View>
                 <View style={{justifyContent:'flex-start',flex:1,flexDirection:'row'}}>
                 <Text>{route.params.dimWeight}</Text>
                 </View>
                </View>
                <View style={{flexDirection:'row',flex:1,justifyContent:'space-around',borderColor:'black',borderWidth:2}}>
                 <View style={{justifyContent:'center',flex:1,flexDirection:'row'}}>
                 ...
                 <View style={{justifyContent:'flex-start',flex:1,flexDirection:'row'}}>
                 <Text>{route.params.caseNetWght}</Text>
                 </View>
                </View>
